...
class SentimentAnalysis:
    ...
    def DownloadData(self):
        ...
        print(str(positive) + "% tweets has positive sentiment.")
        print(str(wpositive) + "% tweets has weakly positive sentiment.")
        print(str(spositive) + "% tweets has strongly positive sentiment.")
        print(str(negative) + "% tweets has negative sentiment.")
        print(str(wnegative) + "% tweets has weakly negative sentiment.")
        print(str(snegative) + "% tweets has strongly negative sentiment.")
        print(str(neutral) + "% tweets has neutral sentiment.")
    ...
    def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, searchTerm, noOfSearchTerms):
        ...
        colors = ['green','lightgreen','darkgreen', 'yellow', 'red','lightsalmon','darkred']
